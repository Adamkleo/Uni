...
{
       0,     0,     3,     4,     8,    12,    17,    19,    23,    25,
      27,    31,    35,    39,    43,    45,    47
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      16,     0,    -1,    -1,    16,    17,    11,    -1,    19,    18,
      12,    -1,     3,    13,    20,    12,    -1,     3,    -1,    18,
      14,     3,    -1,     5,    -1,     6,    -1,    20,     7,    21,
      -1,    20,     8,    21,    -1,    20,     9,    21,    -1,    20,
      10,    21,    -1,    21,    -1,     3,    -1,     4,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    54,    54,    55,    59,    60,    64,    65,    70,    71,
      75,    76,    77,    78,    79,    83,    84
};
#endif
...
{
  "$end", "error", "$undefined", "ID", "NUMBER", "NUM", "LOG", "'+'",
  "'-'", "'*'", "'/'", "'\\n'", "';'", "'='", "','", "$accept", "axiom",
  "statement", "id_list", "type", "expression", "term", 0
};
#endif
...
{
     -13,     0,   -13,   -12,   -13,   -13,     9,     4,    15,   -13,
     -13,   -10,   -13,   -13,     1,   -13,   -13,    18,    15,    15,
...
{
       2,     8,    16,     3,    17,     4,     5,    10,    18,    19,
      20,    21,     0,    22,    24,    25,    26,    27,    12,    13,
       9,    23
};

static const yytype_int8 yycheck[] =
{
       0,    13,    12,     3,    14,     5,     6,     3,     7,     8,
       9,    10,    -1,    12,    18,    19,    20,    21,     3,     4,
      11,     3
};
...
{
       0,    16,     0,     3,     5,     6,    17,    19,    13,    11,
       3,    18,     3,     4,    20,    21,    12,    14,     7,     8,
       9,    10,    12,     3,    21,    21,    21,    21
};
  ...
  switch (yyn)
    {
        case 6:
#line 64 "ex.y"
    { insertVariable((yyvsp[(1) - (1)]).code, "global", (yyvsp[(-1) - (1)]).code); ;}
    break;

  case 7:
#line 65 "ex.y"
    { insertVariable((yyvsp[(3) - (3)]).code, "global", (yyvsp[(-1) - (3)]).code); ;}
    break;
